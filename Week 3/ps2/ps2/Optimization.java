...
public class Optimization {
    ...
    //If array is of length 0, 1, 2, or array has a V shape, or array is strictly increasing: O(1) time
    //
    //Else: O(logn) time
    public static int searchMax(int[] dataArray) {
        ...
        if (length == 0) {
            ...
            if (length == 1) {
                ...
                //Scenario 1 : V shape or last element is the largest
                if (dataArray[0] > dataArray[1] || dataArray[end] > dataArray[end - 1]) {
